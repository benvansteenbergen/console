                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {[
                                ...
                                { id: 'avataaars-3', url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Milo' },
                                { id: 'bottts-1', url: 'https://api.dicebear.com/7.x/bottts/svg?seed=Dusty' },
                                { id: 'bottts-2', url: 'https://api.dicebear.com/7.x/bottts/svg?seed=Pepper' },
                                { id: 'shapes-1', url: 'https://api.dicebear.com/7.x/shapes/svg?seed=Luna' },
                                { id: 'shapes-2', url: 'https://api.dicebear.com/7.x/shapes/svg?seed=Oscar' },
                                { id: 'thumbs-1', url: 'https://api.dicebear.com/7.x/thumbs/svg?seed=Bubba' },
                            ].map((avatar) => (
                                <button
                                    key={avatar.id}
                                    type="button"
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                            Select an avatar for your &quot;Me&quot; personality in Live Chat
                        </p>
                    </div>
